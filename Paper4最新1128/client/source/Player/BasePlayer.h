...
public:
	...
	enum class MODEL{ NORMAL, DIE, PLANE, GUN, SYURIKEN, REND_CALENDAR, REND_MONEY, REND_SIGN, REND_SHINBUN, REND_WC_PAPER, REND_ZASSHI, REND_MAGAZINE, REND_SEISHO, REND_SHOJI, MAX };
