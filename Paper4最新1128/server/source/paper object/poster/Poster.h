...
public:
	...
	void Set_pose(const Vector3& forward, const Vector3& pos); // Žp¨‚ðŒvŽZ‚·‚é
	void Set_pose(const float angle, const Vector3& pos); // Žp¨‚ðŒvŽZ‚·‚é
	...
	bool Can_dist(const Vector3 &pos, float dist, int number);	// vsŽ†“S–C‚Æ‚©‚ÉŽg‚¤
