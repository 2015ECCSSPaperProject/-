...
Skill_gauge::DATA::DATA()
{
	...
	PAPERSIZE = 64;
	PAPERDIST = 48;
	PAPERSTART = { (BACKSIZE.y - PAPERSIZE) * 0.5f, (BACKSIZE.y - PAPERSIZE) * 0.5f };
}
...
{
	textures.back = new iex2DObj("DATA/UI/black.png");

	textures.dot = new iex2DObj("DATA/UI/dot.png");

	textures.paper[0] = new iex2DObj("DATA/UI/blue.png");
	textures.paper[1] = new iex2DObj("DATA/UI/green.png");
	textures.paper[2] = new iex2DObj("DATA/UI/blue.png");
	textures.paper[3] = new iex2DObj("DATA/UI/red.png");
	textures.paper[4] = new iex2DObj("DATA/UI/green.png");
	textures.paper[5] = new iex2DObj("DATA/UI/red.png");
	textures.paper[6] = new iex2DObj("DATA/UI/white.png");
	textures.paper[7] = new iex2DObj("DATA/UI/blue.png");
	textures.paper[8] = new iex2DObj("DATA/UI/green.png");
	textures.paper[9] = new iex2DObj("DATA/UI/white.png");
}
